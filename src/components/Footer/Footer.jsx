      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            {
              icon: <FaLinkedin />,
              link: "https://www.linkedin.com/in/shahe-alam-6a552b320/",
            },
            { icon: <FaGithub />, link: "https://github.com/WebXWizard" },
            {
              icon: <FaInstagram />,
              link: "https://www.instagram.com/webXwizard_143/",
            },
          ].map((item, index) => (
            <a
              key={index}
        ...
        <p className="text-sm text-gray-400 mt-6">
          © 2025 Shahe Alam. All rights reserved.
        </p>
      </div>
    </footer>
  );
